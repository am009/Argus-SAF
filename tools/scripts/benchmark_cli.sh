...
java -jar $BASEDIR/../../binaries/argus-saf-3.2.1-SNAPSHOT-assembly.jar jnsaf /tmp/apks/ 55001 localhost 50051 &
jnsaf_pid=$!
...
{
    java -jar $BASEDIR/../../binaries/argus-saf-3.2.1-SNAPSHOT-assembly.jar benchmark -a COMPONENT_BASED $BASEDIR/../../benchmarks/DroidBench localhost 55001 $BASEDIR/../../benchmarks/expected_droid_bench.txt
}

icc_bench_submitter()
{
    java -jar $BASEDIR/../../binaries/argus-saf-3.2.1-SNAPSHOT-assembly.jar benchmark -a COMPONENT_BASED $BASEDIR/../../benchmarks/ICCBench localhost 55001 $BASEDIR/../../benchmarks/expected_icc_bench.txt
}
